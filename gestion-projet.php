...
<html>
    ...
    <body>
        ...
        <article>
            ...
            <ul>
                <li>DEPOSIER Lilian : Au cours de ce projet, j'ai été responsable de la machine virtuelle (VM) dédiée au transfert de données, de son paramétrage à la configuration des conteneurs Docker. Par la suite, j'ai pris en charge le déploiement et l'utilisation de Node-RED et Grafana. Ces outils m'ont permis d'assurer la récupération des flux de données en temps réel et de concevoir des tableaux de bord dynamiques (notamment via des jauges de suivi) pour la supervision de l'activité. </li>
